...
Future<void> main() async {
  ...
  try {
    ...
    if (provResponse.statusCode != 200) throw Exception('Failed to fetch provinces');
    ...
    for (var prov in provinces) {
      ...
      final regResponse = await http.get(Uri.parse('$baseUrl/regencies/$provId.json'));
    ...
    for (var item in consolidatedData) {
      content.writeln("  {'province': '${_escape(item['province']!)}', 'city': '${_escape(item['city']!)}', 'label': '${_escape(item['label']!)}'},");
    }
