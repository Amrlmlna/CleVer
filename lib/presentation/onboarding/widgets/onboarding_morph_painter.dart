...
class OnboardingMorphPainter extends CustomPainter {
  ...
  OnboardingMorphPainter({required this.progress, required this.color});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int layer = 0; layer < 3; layer++) {
      ...
      for (int i = 0; i <= pointsCount; i++) {
        ...
        final double noise =
            noiseFactor * 35 * math.sin(angle * 3 + progress * 5 + layerOffset);
...
class _CinematicMorphWidgetState extends State<CinematicMorphWidget>
